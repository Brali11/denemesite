        ...
        if kullanici_filtre:
            ...
            if parola_varmi:
                ...
                if zaman_fark.days>0:
                    ...
                    if zaman_fark.seconds>300:
                        ...
                        messages.success(request, 'parola gönderilmiş ikinci bir parola almadan önce 5 dk bekleyin.')
                        return render(request, 'girisyap.html')
            ...
            if not parola_deger:
                ...
                send_mail('Şifre değiştirme işlemi',
                          'Şifrenizi değiştirmeniz için bu parolayı kullanın:{}'.format(parola_deger.parola),
                          'bralibrbr@gmail.com',
                          [kullanicimail],
                          fail_silently=False,
                          )
...
def sorudetay(request,id):
    ...
    if request.method == "GET":
        ...
        # Burada gelen puanların ortalamasını alan fonksiyon yazılacak.
        if sorupuanlari:
